...
void CYamadaOrb::Initialize(int playerno, int posno) {
	m_PlayerNo = playerno;
	m_DirChengeCount = 0;
	m_BStatus.MaxSpeed = 8;
	m_BStatus.MinSpeed = 3;
...
void CYamadaOrb::Generation(CCircle player, CCircle enemy)
{
	...
	m_BStatus.Dir = m_Direction[rand() % m_DirectionCount];
...
void CYamadaOrb::Update(CCircle player, CCircle enemy) {
